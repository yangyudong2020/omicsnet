...
from nnunetv2.configuration import USING_UNETRPP, IS_COMPARING
from nnunetv2.run.load_pretrained_weights import load_pretrained_weights
if IS_COMPARING:
    from nnunetv2.training.nnUNetTrainer.nnUNetTrainerCOMPARE import nnUNetTrainer
elif USING_UNETRPP:
    from nnunetv2.training.nnUNetTrainer.nnUNetTrainerUNETR import nnUNetTrainer
else:
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if num_gpus > 1:
        ...
        if val_with_best:
            ...
            nnunet_trainer.load_checkpoint(join(nnunet_trainer.output_folder, 'checkpoint_best.pth'))
        nnunet_trainer.perform_actual_validation('final', export_validation_probabilities)
