...
class nnUNetDataLoader2D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        for j, current_key in enumerate(selected_keys):
            ...
            data, seg, properties, feature = self._data.load_case(current_key)
        ...
        return {'data': data_all, 'seg': seg_all, 'properties': case_properties, 'keys': selected_keys, 'feature': np.array(features)}
