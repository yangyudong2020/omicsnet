...
class nnUNetDataset(object):
    ...
    def load_case(self, key):
        ...
        fea_path = entry['data_file'].replace('preprocessed', 'raw')
        suf_path = fea_path.split('/')[-2]+'/'+fea_path.split('/')[-1]
        item_name = fea_path.split('/')[-1].split('.')[0]
        fea_path = fea_path.replace(suf_path, f'featuresTr/{item_name}_0000.npy')
        feature = None
        ...
        return data, seg, entry['properties'], feature
