...
from nnunetv2.configuration import ANISO_THRESHOLD, default_num_processes, trainloader_num_processes, num_iterations_per_epoch, num_epochs, num_valid, start_num_valid, initial_learning_rate
...
class nnUNetTrainer(object):
    ...
    def validation_step(self, batch: dict) -> dict:
        data = batch['data']
        target = batch['target']
        # print('properties is', batch['properties'])
        # print('self.plans_manager is', self.plans_manager)
        # print('self.configuration_manager is', self.configuration_manager)
        # print('self.dataset_json is', self.dataset_json)
